...
const userCommitments = [
  "تقديم بيانات صحيحة عند إنشاء الطلب أو التواصل مع فريق الدعم.",
  "عدم إساءة استخدام الموقع أو محاولة التأثير على تشغيله.",
  "مراجعة تعليمات الاستخدام والجرعات قبل تطبيق أي منتج.",
] as const;
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-white/40">
                قواعد أساسية لضمان استخدام آمن وواضح للموقع
              </p>
            </div>
          </div>
