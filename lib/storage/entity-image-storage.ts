...
export class FilesystemEntityImageStorage implements EntityImageStorage {
  ...
  constructor(private readonly entityType: "plants" | "diseases" | "pests") { this.root = path.join(process.cwd(), "public", "uploads", entityType); }
...
export const getEntityImageStorage = (entityType: "plants" | "diseases" | "pests") => new FilesystemEntityImageStorage(entityType);
